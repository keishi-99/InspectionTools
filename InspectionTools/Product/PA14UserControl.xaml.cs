    ...
    public partial class PA14UserControl : UserControl, IMainWindowAware, IDisposable {
        ...
        private void RegDictionary() {
            ...
            _dicCommands[_instDmm01] =
                (
                    Init: new() { Mode = DmmMode.DCV, Adc = "*RST,R6,*OPC?", Visa = "*RST;:INIT:CONT 1;:VOLT:DC:RANG 200;*OPC?", Query = true },
                    Settings: []
                );

            _dicCommands[_instDmm02] =
                (
                    Init: new() { Mode = DmmMode.DCI, Adc = "*RST,F5,R6,*OPC?", Visa = "*RST;:INIT:CONT 1;:CONF:CURR:DC;:CURR:DC:RANG 0.2;*OPC?", Query = true },
                    Settings: []
                );
