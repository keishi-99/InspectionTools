    ...
    public partial class EL5000UserControl : UserControl, IMainWindowAware, IDisposable {
        ...
        private void RegDictionary() {
            ...
            _dicCommands[_instDmm01] =
                (
                    Init: new() { Adc = "*RST,F6,R6,*OPC?", Visa = "*RST;:INIT:CONT 1;:CONF:CURR:AC;*OPC?", Query = true },
                    Settings: []
                );
            ...
            _dicCommands[_instDmm02] =
                (
                    ...
                    Settings: [
                            new() { Text = "DCV",   Adc= "*RST,F1,R0,*OPC?",    Visa = "*RST;:INIT:CONT 1;:VOLT:DC:RANG:AUTO ON;*OPC?" },
